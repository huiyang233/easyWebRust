...
<template>
  <CommonPage>
    <AppCard bordered bg="#fafafc dark:black" class="mb-30 min-h-60 rounded-4">
      <n-form class="flex justify-between p-16" @submit.prevent="handleSearch()">
        <n-space wrap :size="[32, 16]">
          <MeQueryItem label="日期" :label-width="50">
            <n-input type="text" v-model:value="queryItems.date" placeholder="请输入日期" clearable />
          </MeQueryItem>
    ...
    <x-n-data-table :loading="loading" :pagination="pagination" :data="tableData" :scroll-x="800"  @update:page="onPageChange">
      ...
      <x-n-data-table-column width="150" key="money" title="金额" />
...
async function handleQuery() {
  try {
    ...
    tableData.value = [{ id: 2, userName: '2409931477', name: '杨辉', phoneNumber: '13402152243', date:'2024-05-05',money: '6160'},
                          { id: 2, userName: '2409931477', name: '杨辉', phoneNumber: '13402152243', date:'2024-06-05',money: '6160'},
                        { id: 2, userName: '2409931477', name: '杨辉', phoneNumber: '13402152243', date:'2024-07-05',money: '6160'},
                         { id: 2, userName: '2409931477', name: '杨辉', phoneNumber: '13402152243', date:'2024-08-05',money: '6160'},
                          ]
